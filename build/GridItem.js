  ...
  _createClass(GridItem, [{
    ...
    function onResizeHandler(e /*: Event*/, _ref4 /*:: */, position, handlerName /*: string*/) /*: void*/{
      ...
      if (elem) {
        ...
        var constrainWidth = function constrainWidth() {
          if (currentLeft + size.width > _this3.props.containerWidth) {
            size.width = currentWidth;
          }
        };
        var constrainHeight = function constrainHeight() {
          if (size.top <= 0) {
            size.height = currentHeight;
          }
        };
        var constrainLeft = function constrainLeft() {
          if (size.left <= 0) {
